  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center overflow-hidden touch-none bg-white" style={{ fontFamily: invitation.font_style || 'inherit' }}>
      ...
      <div className="relative w-full h-full flex items-center justify-center">
        {/* --- ANIMATION D'OUVERTURE (VINYLE OU PELLICULE) - SORTIE DE LA CONDITION POUR ÊTRE AU DESSUS --- */}
        <motion.div 
          initial={{ y: -450 }} 
          animate={isOpened ? { y: invitation.opening_type === 'filmstrip' ? -35 : 25 } : { y: -450 }} 
          transition={{ type: "spring", damping: 25 }} 
          className="absolute top-0 z-40" /* z-40 pour être au dessus de la carte (z-30) mais sous les volets (z-50) */
        >
