      ...
      <header className="h-16 bg-white/80 backdrop-blur-xl border-b border-gray-200/50 flex items-center justify-between px-6 z-[150] shrink-0">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="font-bold text-sm tracking-tight text-gray-900">
            Invit Studio<span className="text-amber-500">.</span>
          </span>
        </div>
        ...
        <button
          onClick={onSave}
          disabled={saving}
          className="bg-black text-white px-4 py-2 rounded-full text-[10px] font-black uppercase tracking-widest flex items-center gap-2 shadow-lg transition-transform active:scale-95 disabled:opacity-60"
        >
