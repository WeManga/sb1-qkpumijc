...
export function InvitationPreview({ invitation }: any) {
  ...
  return (
    <div 
      className={`relative w-full h-full max-h-[650px] flex items-center justify-center overflow-hidden rounded-[3.5rem] shadow-2xl border-[12px] border-gray-50/50 ${getPaperClass()}`} 
      style={{ 
        fontFamily: invitation.font_style || 'inherit', 
        backgroundColor: invitation.background_color || '#ffffff',
