                        ...
                        >
                          <div className="relative">
                            {invitation.opening_style === 'knock' ? (
                              ...
                              <img src="https://njvnmribopknrqvtjkup.supabase.co/storage/v1/object/public/invitations/logo.png%20(2).png" className="w-80 h-80 object-contain drop-shadow-2xl" alt="Sceau" />
                            )}
                          </div>
