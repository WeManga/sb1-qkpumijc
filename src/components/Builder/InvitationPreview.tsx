...
export function InvitationPreview({ invitation }: any) {
  ...
  // Un utilisateur FREE (ou dont le Premium a expiré) ne doit jamais afficher un contour
  // verrouillé (Doré, Coins Antiques, Pointillé Chic), même si la valeur est restée en base
  // suite à un downgrade : on retombe alors sur "Double Liseré".
  ...
  return (
    <div
      ...
      style={{ fontFamily: fontStyle, background: previewBackgroundColor, perspective: '900px' } as CSSProperties}
    >
        ...
        {view === 'envelope' ? (
          ...
          >
            ...
            <motion.div
              ...
              className={`relative z-30 w-[310px] h-[370px] rounded-[3rem] shadow-2xl p-10 flex flex-col items-center justify-between cursor-pointer paper-container ${getPaperClass(effectivePaperType)}`}
          ...
          >
            <div
              className={`relative w-full h-full flex flex-col overflow-y-auto paper-container ${getPaperClass(effectivePaperType)}`}
