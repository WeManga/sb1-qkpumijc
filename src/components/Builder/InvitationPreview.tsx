...
export function InvitationPreview({ invitation }: any) {
  ...
  /* CORRECTIF : Extraction de la couleur de fond */
  const backgroundColor = pick(invitation, ['background_color', 'backgroundcolor'], '#F5F5F7');
  ...
  return (
    /* CORRECTIF : Div enveloppante avec la couleur de fond dynamique */
