          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <label className="flex flex-col items-center justify-center aspect-square bg-gray-50 rounded-[2rem] border-2 border-dashed border-gray-200 cursor-pointer overflow-hidden relative">
                ...
                <span className="absolute inset-0 flex items-center justify-center text-[10px] font-bold text-gray-600 uppercase bg-white/40 text-center px-2 flex flex-col items-center gap-1">Photo de fin (Premium) {invitation.plan_type !== 'PREMIUM' && <Lock size={12} />}</span>
              ...
              {invitation.opening_type === 'filmstrip' && (
                <>
                  <label className="flex flex-col items-center justify-center aspect-square bg-gray-50 rounded-[2rem] border-2 border-dashed border-amber-200 cursor-pointer overflow-hidden relative">
                    {invitation.photo_url_2 ? <img src={invitation.photo_url_2} className="w-full h-full object-cover opacity-30" /> : <Film size={20} className="text-amber-200 mb-2" />}
                    <span className="absolute inset-0 flex items-center justify-center text-[9px] font-black text-amber-900 uppercase bg-white/40 text-center px-2">Vue 02</span>
                    <input type="file" className="hidden" accept="image/*" onChange={(e) => uploadFile(e, 'photo_url_2')} />
                  </label>
                  <label className="flex flex-col items-center justify-center aspect-square bg-gray-50 rounded-[2rem] border-2 border-dashed border-amber-200 cursor-pointer overflow-hidden relative">
                    {invitation.photo_url_3 ? <img src={invitation.photo_url_3} className="w-full h-full object-cover opacity-30" /> : <Film size={20} className="text-amber-200 mb-2" />}
                    <span className="absolute inset-0 flex items-center justify-center text-[9px] font-black text-amber-900 uppercase bg-white/40 text-center px-2">Vue 03</span>
